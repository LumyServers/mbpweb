...
- Paleta del sitio (elegida por el usuario): azul `#4A90E2`, menta `#50E3C2`,
  slate `#2C3E50` (textos/footer/overlays), gris `#EAEDED` (fondos). Apoyos:
  hover `#3A7BD5`, texto gris `#5D6D7E`, blanco. Fuentes: Inter (texto) y
